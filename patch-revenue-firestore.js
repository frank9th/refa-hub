const documentData = {
  ...
  "phases": [
    ...
    },
    {
      ...
      "tasks": [
        { "id": "p4-t1", "text": "Master Selection Lockdown", "detail": "Judges isolate the top tier acts destined for the live shows.", "tag": "admin" },
        ...
        { "id": "p4-t3", "text": "Official Shortlist Announcement", "detail": "Publish the final list across all TV, Radio, and Social Media channels.", "tag": "media" },
        { "id": "p4-t4", "text": "Independent Audit Integration", "detail": "Announce the third-party auditor overseeing the voting to build absolute public trust.", "tag": "admin" }
      ],
      "contestantJourney": {
    ...
    },
    {
      ...
      "tasks": [
        ...
        { "id": "p6-t3", "text": "VIP & Merch Operations", "detail": "Manage the VIP tables and aggressively sell branded merchandise in the lobby.", "tag": "ops" },
        { "id": "p6-t4", "text": "Post-Show Leaderboard Tease", "detail": "Release a controversial mid-week leaderboard update to trigger panic voting.", "tag": "admin" }
      ],
      "contestantJourney": {
    ...
    },
    {
      ...
      "tasks": [
        ...
        { "id": "p8-t5", "text": "Sponsor ROI Delivery", "detail": "Within 5 days, send every sponsor a beautifully packaged report detailing the massive reach and engagement achieved.", "tag": "ops" }
      ],
      "contestantJourney": {
...
async function updateRevenueStrategy() {
  const url = "https://firestore.googleapis.com/v1/projects/refa-hub-2026/databases/(default)/documents/events/hit-the-mic-s3?updateMask.fieldPaths=financials&updateMask.fieldPaths=goals&updateMask.fieldPaths=details&updateMask.fieldPaths=phases";
  const payload = {
    fields: {
      financials: toFirestoreType(documentData.financials),
      goals: toFirestoreType(documentData.goals),
      details: toFirestoreType(documentData.details),
