...
window.TEMPLATES.push({
  ...
  "emoji": "🏅",
  "cat": "social",
  "thumbBg": "linear-gradient(135deg,${s.accentColor},#B45309)",
...
window.RENDERERS['congrats-winner'] = function(w, h, s, gold, bg, tc, img, logo) {
  return `
    <div style="width:${w}px;height:${h}px;background:${s.bgColor};position:relative;overflow:hidden;color:white;font-family:'Inter',sans-serif;display:flex;flex-direction:column;align-items:center;justify-content:center;text-align:center;padding:25px;box-sizing:border-box;">
      ...
      <div style="z-index:2;">
        ...
        <div style="display:inline-block;background:${gold};color:${s.bgColor};font-size:11px;font-weight:900;padding:4px 16px;border-radius:16px;margin-bottom:20px;letter-spacing:2px;">CHAMPION</div>
